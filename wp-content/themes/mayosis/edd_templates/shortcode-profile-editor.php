...
if ( is_user_logged_in() ):
	...
	if ( edd_is_cart_saved() ): ?>
		...
		<div class="edd_success edd-alert edd-alert-success"><strong><?php _e( 'Saved cart','mayosis' ); ?>:</strong> <?php printf( __( 'You have a saved cart, <a href="%s">click here</a> to restore it.', 'mayosis' ), esc_url( $restore_url ) ); ?></div>
	<?php endif; ?>

	<?php if ( isset( $_GET['updated'] ) && $_GET['updated'] == true && ! edd_get_errors() ): ?>
		<div class="edd_success edd-alert edd-alert-success"><strong><?php _e( 'Success','mayosis' ); ?>:</strong> <?php _e( 'Your profile has been edited successfully.', 'mayosis' ); ?></div>
	<?php endif; ?>
	...
	<form id="edd_profile_editor_form" class="edd_form" action="<?php echo edd_get_current_page_url(); ?>" method="post">
		...
		<fieldset id="edd_profile_personal_fieldset">
			...
			<legend id="edd_profile_name_label"><?php _e( 'Change your Name', 'mayosis' ); ?></legend>
		<div class="row">
		    <p id="edd_profile_first_name_wrap" class="col-md-6">
				<label for="edd_first_name"><?php _e( 'First Name', 'mayosis' ); ?></label>
				<input name="edd_first_name" id="edd_first_name" class="text edd-input" type="text" value="<?php echo esc_attr( $first_name ); ?>" />
			</p>

			<p id="edd_profile_last_name_wrap" class="col-md-6">
				<label for="edd_last_name"><?php _e( 'Last Name', 'mayosis' ); ?></label>
				<input name="edd_last_name" id="edd_last_name" class="text edd-input" type="text" value="<?php echo esc_attr( $last_name ); ?>" />
			</p>
	    
			

			<p id="edd_profile_display_name_wrap" class="col-md-6">
				<label for="edd_display_name"><?php _e( 'Display Name', 'mayosis' ); ?></label>
			...
			<p id="edd_profile_primary_email_wrap" class="col-md-6">
				<label for="edd_email"><?php _e( 'Primary Email Address', 'mayosis' ); ?></label>
			...
			<?php if ( $customer->id > 0 && count( $customer->emails ) > 1 ) : ?>
				<p id="edd_profile_emails_wrap" class="col-md-6">
					<label for="edd_emails"><?php _e( 'Additional Email Addresses', 'mayosis' ); ?></label>
					...
					<?php foreach ( $customer->emails as $email ) : ?>
						...
						<li class="edd-profile-email">
							...
							<span class="actions">
								...
								?>
								<a href="<?php echo esc_url($remove_url) ?>" class="delete"><?php _e( 'Remove', 'mayosis' ); ?></a>
							</span>
						</li>
					<?php endforeach; ?>
					</ul>
		...
		<fieldset id="edd_profile_address_fieldset">
			...
			<legend id="edd_profile_billing_address_label"><?php _e( 'Change your Billing Address', 'mayosis' ); ?></legend>
          <div class="row">
			<p id="edd_profile_billing_address_line_1_wrap" class="col-md-6">
				<label for="edd_address_line1"><?php _e( 'Address Line 1', 'mayosis' ); ?></label>
				<input name="edd_address_line1" id="edd_address_line1" class="text edd-input" type="text" value="<?php echo esc_attr( $address['line1'] ); ?>" />
			</p>

			<p id="edd_profile_billing_address_line_2_wrap" class="col-md-6">
				<label for="edd_address_line2"><?php _e( 'Address Line 2', 'mayosis' ); ?></label>
				<input name="edd_address_line2" id="edd_address_line2" class="text edd-input" type="text" value="<?php echo esc_attr( $address['line2'] ); ?>" />
			</p>

			<p id="edd_profile_billing_address_city_wrap" class="col-md-6">
				<label for="edd_address_city"><?php _e( 'City', 'mayosis' ); ?></label>
				<input name="edd_address_city" id="edd_address_city" class="text edd-input" type="text" value="<?php echo esc_attr( $address['city'] ); ?>" />
			</p>

			<p id="edd_profile_billing_address_postal_wrap" class="col-md-6">
				<label for="edd_address_zip"><?php _e( 'Zip / Postal Code', 'mayosis' ); ?></label>
				<input name="edd_address_zip" id="edd_address_zip" class="text edd-input" type="text" value="<?php echo esc_attr( $address['zip'] ); ?>" />
			</p>

			<p id="edd_profile_billing_address_country_wrap" class="col-md-6">
				<label for="edd_address_country"><?php _e( 'Country', 'mayosis' ); ?></label>
			...
			<p id="edd_profile_billing_address_state_wrap" class="col-md-6"> 
				<label for="edd_address_state"><?php _e( 'State / Province', 'mayosis' ); ?></label>
				<?php if( ! empty( $states ) ) : ?>
		...
		<fieldset id="edd_profile_password_fieldset">
			...
			<legend id="edd_profile_password_label"><?php _e( 'Change your Password', 'mayosis' ); ?></legend>

			<p id="edd_profile_password_wrap">
				<label for="edd_new_user_pass1"><?php esc_html_e( 'New Password', 'mayosis' ); ?></label>
			...
			<p id="edd_profile_confirm_password_wrap">
				<label for="edd_new_user_pass2"><?php esc_html_e( 'Re-enter Password', 'mayosis' ); ?></label>
		...
		<fieldset id="edd_profile_submit_fieldset">
			...
			<p id="edd_profile_submit_wrap">
				...
				<input name="edd_profile_editor_submit" id="edd_profile_editor_submit" type="submit" class="edd_submit edd-submit" value="<?php _e( 'Save Changes', 'mayosis' ); ?>"/>
			</p>
