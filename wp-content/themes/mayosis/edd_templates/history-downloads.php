...
if ( ! empty( $_GET['edd-verify-success'] ) ) : ?>
	<p class="edd-account-verified edd_success">
		<?php esc_html_e( 'Your account has been successfully verified!', 'mayosis' ); ?>
	</p>
	<?php
endif;
/**
	...
	<table id="edd_user_history" class="edd-table">
		<thead>
			<tr class="edd_download_history_row">
				...
				<th class="edd_download_download_name"><?php esc_html_e( 'Download Name', 'mayosis' ); ?></th>
				<?php if ( ! edd_no_redownload() ) : ?>
					<th class="edd_download_download_files"><?php esc_html_e( 'Files', 'mayosis' ); ?></th>
						...
						<td class="edd_download_download_files">
							...
							if ( $item->is_deliverable() ) :
								...
								if ( $download_files ) :
									...
									esc_html_e( 'No downloadable files found.', 'mayosis' );
...
<?php else : ?>
	<p class="edd-no-downloads"><?php esc_html_e( 'You have not purchased any downloads', 'mayosis' ); ?></p>
<?php endif; ?>
