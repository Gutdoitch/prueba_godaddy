...
if (class_exists('Marketkingcore_Public')) {
    ...
    $store_user    = $users[0]->ID;
     $authordownload =get_the_author_meta( 'ID',$store_user);
}
 if (class_exists('WeDevs_Dokan')) {
$store_user    = dokan()->vendor->get( get_query_var( 'author' ) );
 $authordownload =get_the_author_meta( 'ID',$store_user->get_id() );
}
...
?>
                ...
                <div class="single--metabox--info col">
                            ...
                            <h4><?php echo count_user_posts($authordownload,'product'); ?></h4>
