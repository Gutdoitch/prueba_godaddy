...
var Merlin = (function($){
    ...
    function window_loaded(){
        ...
        function el_button(){
            $("#default_plugins_elementor, #default_plugins_hub-elementor-addons").prop('checked', true);
            $("#default_plugins_elementor, #default_plugins_hub-elementor-addons").attr('disabled', false);
            $("#default_plugins_elementor, #default_plugins_hub-elementor-addons").parent().css( "display", "list-item" );
            $("#default_plugins_liquid_js_composer, #default_plugins_liquid-gdpr").prop('checked', false);
            $("#default_plugins_liquid_js_composer").attr('disabled', true);
            $("#default_plugins_liquid_js_composer").parent().css( "display", "none" );
        }

        function vc_button(){
            $("#default_plugins_elementor, #default_plugins_hub-elementor-addons").prop('checked', false);
            $("#default_plugins_elementor, #default_plugins_hub-elementor-addons").attr('disabled', true);
            $("#default_plugins_elementor, #default_plugins_hub-elementor-addons").parent().css( "display", "none" );
            $("#default_plugins_liquid_js_composer").prop('checked', true);
            $("#default_plugins_liquid_js_composer").attr('disabled', false);
            $("#default_plugins_liquid_js_composer").parent().css( "display", "list-item" );
        }
        ...
        $( ".merlin__builder--woocommerce" ).click(function() {
            ...
            localStorage.setItem('liquid_setup_builder', 'wpbakery');
        });
