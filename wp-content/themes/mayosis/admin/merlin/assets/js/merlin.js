...
var Merlin = (function($){
    ...
    function window_loaded(){
        ...
        if (!localStorage.getItem('liquid_setup_builder')){
            localStorage.setItem('liquid_setup_builder', 'elementor');
        }

        if (localStorage.getItem('liquid_setup_builder') === 'elementor'){
            $(".active-builder-elementor").css( "display", "flex" );
        } else {
            $(".active-builder-wpbakery").css( "display", "flex" );
        }


        function set_default_plugins(){
            var current_url = window.location.href;

            if (current_url.includes("?page=liquid-about")){
                el_button();
            } else {
                vc_button();
            }
			...
			$("#default_plugins_woocommerce").parent().css( "display", "none" );
			
			
			 $("#default_plugins_easy-digital-downloads, #default_plugins_edd-featured-downloads,#default_plugins_fontier").prop('checked', true);
            $("#default_plugins_easy-digital-downloads, #default_plugins_edd-featured-downloads,#default_plugins_fontier").parent().css( "display", "list-item" );
        ...
        function el_button(){
            $("#default_plugins_easy-digital-downloads, #default_plugins_edd-featured-downloads,#default_plugins_fontier").prop('checked', true);
            $("#default_plugins_easy-digital-downloads, #default_plugins_edd-featured-downloads,#default_plugins_fontier").parent().css( "display", "list-item" );
            $("#default_plugins_woocommerce").prop('checked', false);
            $("#default_plugins_woocommerce").attr('disabled', true);
            $("#default_plugins_woocommerce").parent().css( "display", "none" );
        }

        function vc_button(){
            $("#default_plugins_easy-digital-downloads, #default_plugins_edd-featured-downloads,#default_plugins_fontier").prop('checked', false);
            $("#default_plugins_easy-digital-downloads, #default_plugins_edd-featured-downloads,#default_plugins_fontier").parent().css( "display", "none" );
            $("#default_plugins_woocommerce").prop('checked', true);
            $("#default_plugins_woocommerce").attr('disabled', true);
            $("#default_plugins_woocommerce").parent().css( "display", "list-item" );
        }

        $( ".merlin__builder--edd" ).click(function() {
            el_button();
            $(this).addClass( "active" );
            $(".merlin__builder--woocommerce").removeClass( "active" );
           
        });

        $( ".merlin__builder--woocommerce" ).click(function() {
            vc_button();
            $(this).addClass( "active" );
            $(".merlin__builder--edd").removeClass( "active" );
            ...
            init: function(btn){
                ...
                complete = function(){
                    ...
                    setTimeout(function(){
                        ...
                        if (btn_href.includes("#install-about")){
                            location.reload();
                        } else {
                            window.location.href=btn.href;
                        }
