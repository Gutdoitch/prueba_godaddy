...
class Merlin {
	...
	function __construct( $config = array(), $strings = array() ) {
		...
		$config = wp_parse_args(
			$config, array(
				...
				'directory'            => 'admin/merlin',
				'merlin_url'           => 'mayosis-wizard',
	...
	public function admin_page() {
		...
		wp_add_inline_style( 'merlin', '#qm-icon-container,#query-monitor-main{display:none}' ); // Hide Query Monitor plugin.
		 ...
		 wp_enqueue_style( 'merlin-dashboard-style',MAYOSIS_THEMEPATH . '/css/merlin-dashboard.min.css' );
		 
		 wp_enqueue_style( 'jquery-confirm-css',MAYOSIS_THEMEPATH . '/css/jquery-confirm.min.css' );
		...
		wp_enqueue_script('jquery-confirm',MAYOSIS_THEMEPATH . '/js/jquery-confirm.min.js', array('jquery'), '5.0', true);
		
		wp_enqueue_script('jquery-custom-select',MAYOSIS_THEMEPATH . '/js/jquery.customselect.min.js', array('jquery'), '5.0', true);
...
/**
	...
	protected function license() {
		...
		<?php
		$this->logger->debug( __( 'The license activation step has been displayed', 'mayosis' ) );
	}
	...
	protected function plugins() {
		...
		<div class="merlin__content--transition">
			...
			<div class="merlin__builder-buttons">
				...
				<p>Currently WooCommerce is Enabled.</p>
				<div>
					
					<span class="merlin__builder--woocommerce active"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/woocommerce-icon.gif'); ?>">WooCommerce</span>
				</div>
				
				<?php } elseif (class_exists('Easy_Digital_Downloads')){ ?>
				
				<p>Currently EDD is Enabled.</p>
				
				<div>
					<span class="merlin__builder--edd active"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/edd-icon.svg'); ?>">EDD</span>
				
				</div>
				
				<?php } else { ?>
				<p>Chose your favorite eCommerce plugin</p>
				<div>
					<span class="merlin__builder--edd active"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/edd-icon.svg'); ?>">EDD</span>
					<span class="merlin__builder--woocommerce"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/woocommerce-icon.gif'); ?>">WooCommerce</span>
				</div>
				<?php } ?>
			</div>
...
<div class="demo-import-required-options">
			...
			<a id="merlin__drawer-trigger" class="merlin__button merlin__button--knockout"><span><?php echo esc_html( $action ); ?></span><span class="chevron"></span></a>
			<?php } else { ?>
			<h4 class="dh-plugin-required">Please Install and Activate Mayosis Core Plugin to continue import demo.</h4>
			<?php } ?>
	...
	function elementor_update_options() {
		...
		update_option( 'elementor_cpt_support', [ 'page', 'post', 'product_template', 'footer_builder', 'edd_archive_builder', 'mayosis_block' ] );
	}
