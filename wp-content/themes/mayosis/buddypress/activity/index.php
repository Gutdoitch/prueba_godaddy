...
<div id="buddypress">
 ...
 <div id="item-header-wrap" class="d-none d-md-block">
	...
	<div class="item-list-tabs activity-type-tabs" aria-label="<?php esc_attr_e( 'Sitewide activities navigation', 'mayosis' ); ?>" role="navigation">
		<ul>
			<?php
			...
			<li class="selected" id="activity-all">
				<a href="<?php bp_activity_directory_permalink(); ?>">
					...
					printf( __( 'All Members %s', 'mayosis' ), '<span>' . bp_get_total_member_count() . '</span>' );
					?>
				</a>
			</li>
					...
					<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
						...
						<li id="activity-friends">
							<a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>">
								...
								printf( __( 'My Friends %s', 'mayosis' ), '<span>' . bp_get_total_friend_count( bp_loggedin_user_id() ) . '</span>' );
								?>
							</a>
						</li>
				...
				<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
					...
					<li id="activity-favorites">
						<a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>">
							...
							printf( __( 'My Favorites %s', 'mayosis' ), '<span>' . bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) . '</span>' );
							?>
						</a>
					</li>
							...
							<?php if ( bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ) : ?>
								...
								<strong>
									<span>
										...
										printf( _nx( '%s new', '%s new', bp_get_total_mention_count_for_user( bp_loggedin_user_id() ), 'Number of new activity mentions', 'mayosis' ), bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) );
										?>
									</span>
								</strong>
							<?php endif; ?>
	...
	<div class="item-list-tabs no-ajax" id="subnav" aria-label="<?php esc_attr_e( 'Activity secondary navigation', 'mayosis' ); ?>" role="navigation">
		<ul>
			<li class="feed"><a href="<?php bp_sitewide_activity_feed_link(); ?>" class="bp-tooltip" data-bp-tooltip="<?php esc_attr_e( 'RSS Feed', 'mayosis' ); ?>" aria-label="<?php esc_attr_e( 'RSS Feed', 'mayosis' ); ?>"><?php _e( 'RSS', 'mayosis' ); ?></a></li>
