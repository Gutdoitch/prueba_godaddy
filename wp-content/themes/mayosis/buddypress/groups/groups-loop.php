	...
	<?php while ( bp_groups() ) : bp_the_group(); ?>
		...
		<li <?php bp_group_class(); ?>>
			...
			<div class="item">
				...
				<div class="item-meta"><span class="activity" data-livestamp="<?php bp_core_iso8601_date( bp_get_group_last_active( 0, array( 'relative' => false ) ) ); ?>"><?php printf( __( 'active %s', 'mayosis' ), bp_get_group_last_active() ); ?></span></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'There were no groups found.', 'mayosis' ); ?></p>
	</div>
