...
<?php if ($bgtype=="featured"){ ?>
  <div class="product-archive-breadcrumb-woo woo-archive-breadcrumb-<?php echo esc_html($bgtype);?> container-fluid has_mayosis_dark_alt_bg" style="background:url(<?php echo esc_url($catimage);?>)">
<?php } else { ?>
