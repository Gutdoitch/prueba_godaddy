...
/*  jQuery Nice Select - v1.0
    https://github.com/hernansartorio/jquery-mayosel-select
    Made by Hernán Sartorio  */
!function(e){e.fn.niceSelect=function(t){function s(t){t.after(e("<div></div>").addClass("mayosel-select").addClass(t.attr("class")||"").addClass(t.attr("disabled")?"disabled":"").attr("tabindex",t.attr("disabled")?null:"0").html('<span class="current"></span><ul class="list"></ul>'));var s=t.next(),n=t.find("option"),i=t.find("option:selected");s.find(".current").html(i.data("display")||i.text()),n.each(function(t){var n=e(this),i=n.data("display");s.find("ul").append(e("<li></li>").attr("data-value",n.val()).attr("data-display",i||null).addClass("option"+(n.is(":selected")?" selected":"")+(n.is(":disabled")?" disabled":"")).html(n.text()))})}if("string"==typeof t)return"update"==t?this.each(function(){var t=e(this),n=e(this).next(".mayosel-select"),i=n.hasClass("open");n.length&&(n.remove(),s(t),i&&t.next().trigger("click"))}):"destroy"==t?(this.each(function(){var t=e(this),s=e(this).next(".mayosel-select");s.length&&(s.remove(),t.css("display",""))}),0==e(".mayosel-select").length&&e(document).off(".nice_select")):console.log('Method "'+t+'" does not exist.'),this;this.hide(),this.each(function(){var t=e(this);t.next().hasClass("mayosel-select")||s(t)}),e(document).off(".nice_select"),e(document).on("click.nice_select",".mayosel-select",function(t){var s=e(this);e(".mayosel-select").not(s).removeClass("open"),s.toggleClass("open"),s.hasClass("open")?(s.find(".option"),s.find(".focus").removeClass("focus"),s.find(".selected").addClass("focus")):s.focus()}),e(document).on("click.nice_select",function(t){0===e(t.target).closest(".mayosel-select").length&&e(".mayosel-select").removeClass("open").find(".option")}),e(document).on("click.nice_select",".mayosel-select .option:not(.disabled)",function(t){var s=e(this),n=s.closest(".mayosel-select");n.find(".selected").removeClass("selected"),s.addClass("selected");var i=s.data("display")||s.text();n.find(".current").text(i),n.prev("select").val(s.data("value")).trigger("change")}),e(document).on("keydown.nice_select",".mayosel-select",function(t){var s=e(this),n=e(s.find(".focus")||s.find(".list .option.selected"));if(32==t.keyCode||13==t.keyCode)return s.hasClass("open")?n.trigger("click"):s.trigger("click"),!1;if(40==t.keyCode){if(s.hasClass("open")){var i=n.nextAll(".option:not(.disabled)").first();i.length>0&&(s.find(".focus").removeClass("focus"),i.addClass("focus"))}else s.trigger("click");return!1}if(38==t.keyCode){if(s.hasClass("open")){var l=n.prevAll(".option:not(.disabled)").first();l.length>0&&(s.find(".focus").removeClass("focus"),l.addClass("focus"))}else s.trigger("click");return!1}if(27==t.keyCode)s.hasClass("open")&&s.trigger("click");else if(9==t.keyCode&&s.hasClass("open"))return!1});var n=document.createElement("a").style;return n.cssText="pointer-events:auto","auto"!==n.pointerEvents&&e("html").addClass("no-csspointerevents"),this}}(jQuery);
/*
 ...
 * http://modernizr.com/download/?-applicationcache-audio-backgroundsize-borderimage-borderradius-boxshadow-canvas-canvastext-cssanimations-csscolumns-cssgradients-cssreflections-cssresize-csstransforms-csstransforms3d-csstransitions-cssvhunit-cssvwunit-flexbox-flexboxlegacy-fontface-generatedcontent-geolocation-hashchange-history-hsla-indexeddb-inlinesvg-input-inputtypes-localstorage-multiplebgs-opacity-postmessage-rgba-sessionstorage-smil-srcset-svg-svgclippaths-textshadow-touchevents-video-webgl-websockets-websqldatabase-webworkers-domprefixes-hasevent-mq-prefixes-setclasses-shiv-testallprops-testprop-teststyles !*/
 ...
 **/
 jQuery.fn.select2Buttons=function(e){return this.each(function(){var t=jQuery,a=t(this),s=a.attr("multiple");a.hide();var d=t('<div class="select2Buttons"></div>'),i=0,n=function(s){s.attr("label")&&d.append("<strong>"+s.attr("label")+"</strong>");var n=t('<ul class="select-buttons">');s.children("option").each(function(){var s=t("<li></li>");t(this).attr("disabled")||a.attr("disabled")?(s.addClass("disabled"),s.append("<span>"+t(this).html()+"</span>")):s.append('<a href="#" data-select-index="'+i+'">'+t(this).html()+"</a>"),e&&e.noDefault||!t(this).attr("selected")||s.children("a, span").addClass("picked"),n.append(s),i++}),d.append(n)},l=a.children("optgroup");0==l.length?n(a):l.each(function(){n(t(this))}),a.after(d),d.find("a").click(function(e){e.preventDefault();var i=t(a.find("option")[t(this).attr("data-select-index")]);s?i.attr("selected")?(t(this).removeClass("picked"),i.removeAttr("selected")):(t(this).addClass("picked"),i.attr("selected","selected")):(d.find("a, span").removeClass("picked"),t(this).addClass("picked"),i.attr("selected","selected")),a.trigger("change")})})};
