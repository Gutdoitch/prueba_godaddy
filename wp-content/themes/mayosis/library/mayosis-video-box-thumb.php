...
?>
<div class="msv-video-bx--wrapper msv-video-bx--wrapper-vd-thumb">
     <a class="ms-pr-acnhor_replace" href="<?php the_permalink();?>"> </a>
...
<video id="mayosisplayergrid"
      muted="true" playsinline  <?php if ($productthumbposter=='show'){ ?>poster="<?php echo esc_url($posterimage[0]);?>"<?php }?> controls><source src="<?php echo esc_url($mayosis_video);?>" type="video/mp4" />
