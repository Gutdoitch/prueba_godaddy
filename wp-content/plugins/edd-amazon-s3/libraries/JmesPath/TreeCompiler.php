<?php
namespace EDDAmazon\Vendor\JmesPath;
...
class TreeCompiler
{
    ...
    public function visit(array $ast, $fnName, $expr)
    {
        ...
        $this->write("<?php\n")
            ->write('use EDDAmazon\Vendor\JmesPath\\TreeInterpreter as Ti;')
            ->write('use EDDAmazon\Vendor\JmesPath\\FnDispatcher as Fd;')
            ->write('use EDDAmazon\Vendor\JmesPath\\Utils;')
            ->write('')
