...
use EDDAmazon\Vendor\Aws\Token\TokenAuthorization;
...
final class Middleware
{
     ...
     *
     * @param callable $f Map function that accepts an EDDAmazon\Vendor\Aws\ResultInterface and
     *                    returns an EDDAmazon\Vendor\Aws\ResultInterface.
     *
     * @return callable
     */
