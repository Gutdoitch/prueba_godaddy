...
use EDDAmazon\Vendor\Aws\Endpoint\PartitionInterface;
...
class MultiRegionClient implements AwsClientInterface
{
        ...
        return $args + [
                'client_factory' => [
                    ...
                    'default' => function (array $args) {
                        ...
                        $klass = "EDDAmazon\Vendor\Aws\\{$namespace}\\{$namespace}Client";
     ...
     * - partition: (EDDAmazon\Vendor\Aws\Endpoint\Partition|string) AWS partition to connect to.
