<?php
namespace EDDAmazon\Vendor\Aws\Endpoint\UseDualstackEndpoint;

use EDDAmazon\Vendor\Aws\AbstractConfigurationProvider;
use EDDAmazon\Vendor\Aws\CacheInterface;
use EDDAmazon\Vendor\Aws\ConfigurationProviderInterface;
use EDDAmazon\Vendor\Aws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
use EDDAmazon\Vendor\GuzzleHttp\Promise;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \EDDAmazon\Vendor\Aws\Endpoint\UseDualstackEndpoint\onfigurationInterface}
 * or rejected with an {@see \EDDAmazon\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationException}.
 *
 * <code>
 * use EDDAmazon\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider;
 ...
 * {@see EDDAmazon\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider::chain}. This function
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini($region, $profile = null, $filename = null)
    {
        ...
        return function () use ($region, $profile, $filename) {
            ...
            $data = \EDDAmazon\Vendor\Aws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
