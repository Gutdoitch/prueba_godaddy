...
use EDDAmazon\Vendor\JmesPath\Env;
...
class PartitionEndpointProvider
{
    ...
    {
        $data = \EDDAmazon\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \EDDAmazon\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
