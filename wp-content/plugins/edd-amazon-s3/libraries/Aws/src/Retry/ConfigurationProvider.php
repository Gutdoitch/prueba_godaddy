<?php
namespace EDDAmazon\Vendor\Aws\Retry;
...
use EDDAmazon\Vendor\Aws\Retry\Exception\ConfigurationException;
use EDDAmazon\Vendor\GuzzleHttp\Promise;
use EDDAmazon\Vendor\GuzzleHttp\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \EDDAmazon\Vendor\Aws\Retry\ConfigurationInterface}
 * or rejected with an {@see \EDDAmazon\Vendor\Aws\Retry\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see \EDDAmazon\Vendor\Aws\Retry\ConfigurationProvider::chain}. This function
