<?php
namespace EDDAmazon\Vendor\Aws\DefaultsMode;
...
use EDDAmazon\Vendor\Aws\DefaultsMode\Exception\ConfigurationException;
use EDDAmazon\Vendor\GuzzleHttp\Promise;
use EDDAmazon\Vendor\GuzzleHttp\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \EDDAmazon\Vendor\Aws\DefaultsMode\ConfigurationInterface}
 * or rejected with an {@see \EDDAmazon\Vendor\Aws\DefaultsMode\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see \EDDAmazon\Vendor\Aws\DefaultsMode\ConfigurationProvider::chain}. This function
