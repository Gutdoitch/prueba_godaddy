...
namespace EDDAmazon\Vendor\Aws\Configuration;
...
class ConfigurationResolver
{
    ...
    {
        if ($type === 'bool'
            && !is_null($convertedValue = \EDDAmazon\Vendor\Aws\boolean_value($value))
        ) {
    ...
    private static function retrieveValueFromIniSubsection(
        ...
        $services_section = \EDDAmazon\Vendor\Aws\parse_ini_section_with_subsections(
            $filename,
