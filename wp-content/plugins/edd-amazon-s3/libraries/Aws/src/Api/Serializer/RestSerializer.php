<?php
namespace EDDAmazon\Vendor\Aws\Api\Serializer;

use EDDAmazon\Vendor\Aws\Api\MapShape;
use EDDAmazon\Vendor\Aws\Api\Service;
use EDDAmazon\Vendor\Aws\Api\Operation;
use EDDAmazon\Vendor\Aws\Api\Shape;
use EDDAmazon\Vendor\Aws\Api\StructureShape;
use EDDAmazon\Vendor\Aws\Api\TimestampShape;
use EDDAmazon\Vendor\Aws\CommandInterface;
use EDDAmazon\Vendor\Aws\EndpointV2\EndpointProviderV2;
use EDDAmazon\Vendor\Aws\EndpointV2\EndpointV2SerializerTrait;
use EDDAmazon\Vendor\GuzzleHttp\Psr7;
use EDDAmazon\Vendor\GuzzleHttp\Psr7\Request;
use EDDAmazon\Vendor\GuzzleHttp\Psr7\Uri;
use EDDAmazon\Vendor\GuzzleHttp\Psr7\UriResolver;
