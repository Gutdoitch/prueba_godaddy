<?php
namespace EDDAmazon\Vendor\Aws\Api;

use EDDAmazon\Vendor\Aws\Exception\UnresolvedApiException;
 ...
 * {@see EDDAmazon\Vendor\Aws\Exception\UnresolvedApiException}.
 *
 ...
 * {@see EDDAmazon\Vendor\Aws\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \EDDAmazon\Vendor\Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \EDDAmazon\Vendor\Aws\load_compiled_json($path);
