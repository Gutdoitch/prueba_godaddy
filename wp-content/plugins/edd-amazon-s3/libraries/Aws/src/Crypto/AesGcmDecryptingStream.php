<?php
namespace EDDAmazon\Vendor\Aws\Crypto;

use EDDAmazon\Vendor\Aws\Exception\CryptoException;
use EDDAmazon\Vendor\GuzzleHttp\Psr7;
use EDDAmazon\Vendor\GuzzleHttp\Psr7\StreamDecoratorTrait;
use EDDAmazon\Vendor\Psr\Http\Message\StreamInterface;
use EDDAmazon\Vendor\Aws\Crypto\Polyfill\AesGcm;
use EDDAmazon\Vendor\Aws\Crypto\Polyfill\Key;
