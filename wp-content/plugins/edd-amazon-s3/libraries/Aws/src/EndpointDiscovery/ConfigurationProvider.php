<?php
namespace EDDAmazon\Vendor\Aws\EndpointDiscovery;
...
use EDDAmazon\Vendor\Aws\EndpointDiscovery\Exception\ConfigurationException;
use EDDAmazon\Vendor\GuzzleHttp\Promise;
use EDDAmazon\Vendor\GuzzleHttp\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \EDDAmazon\Vendor\Aws\EndpointDiscovery\ConfigurationInterface}
 * or rejected with an {@see \EDDAmazon\Vendor\Aws\EndpointDiscovery\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see EDDAmazon\Vendor\Aws\EndpointDiscovery\ConfigurationProvider::chain}. This function
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini(
        ...
        return function () use ($profile, $filename, $cacheLimit) {
            ...
            $data = \EDDAmazon\Vendor\Aws\parse_ini_file($filename, true);
            if ($data === false) {
