...
use EDDAmazon\Vendor\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(
        ...
        $request = \EDDAmazon\Vendor\Aws\serialize($newCmd);
        // Create the new endpoint for the target endpoint.
        if ($this->endpointProvider instanceof \EDDAmazon\Vendor\Aws\EndpointV2\EndpointProviderV2) {
