<?php
namespace EDDAmazon\Vendor\Aws\Handler\GuzzleV5;

use Exception;
use EDDAmazon\Vendor\GuzzleHttp\Client;
use EDDAmazon\Vendor\GuzzleHttp\ClientInterface;
use EDDAmazon\Vendor\GuzzleHttp\Event\EndEvent;
use EDDAmazon\Vendor\GuzzleHttp\Exception\ConnectException;
use EDDAmazon\Vendor\GuzzleHttp\Exception\RequestException;
use EDDAmazon\Vendor\GuzzleHttp\Message\ResponseInterface as GuzzleResponse;
use EDDAmazon\Vendor\GuzzleHttp\Promise;
use EDDAmazon\Vendor\GuzzleHttp\Psr7\Response as Psr7Response;
use EDDAmazon\Vendor\GuzzleHttp\Stream\Stream;
use EDDAmazon\Vendor\Psr\Http\Message\RequestInterface as Psr7Request;
use EDDAmazon\Vendor\Psr\Http\Message\StreamInterface as Psr7StreamInterface;
...
class GuzzleHandler
{
     ...
     * @throws \EDDAmazon\Vendor\GuzzleHttp\Exception\GuzzleException
     */
