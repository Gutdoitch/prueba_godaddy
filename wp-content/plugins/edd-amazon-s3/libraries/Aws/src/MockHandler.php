 ...
 * EDDAmazon\Vendor\Aws\ResultInterface and EDDAmazon\Vendor\Aws\Exception\AwsException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see EDDAmazon\Vendor\Aws\ResultInterface} or
    ...
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                ...
                throw new \InvalidArgumentException('Expected an EDDAmazon\Vendor\Aws\ResultInterface or Exception.');
            }
        }
    }
