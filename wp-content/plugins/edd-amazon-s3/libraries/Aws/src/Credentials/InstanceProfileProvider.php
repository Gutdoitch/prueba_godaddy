...
use EDDAmazon\Vendor\Aws\Exception\InvalidJsonException;
use EDDAmazon\Vendor\Aws\Sdk;
use EDDAmazon\Vendor\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = isset($config['client'])
            ...
            : \EDDAmazon\Vendor\Aws\default_http_handler();
    }
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \EDDAmazon\Vendor\Aws\default_user_agent();
