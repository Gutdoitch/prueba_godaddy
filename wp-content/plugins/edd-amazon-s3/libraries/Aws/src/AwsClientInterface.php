...
interface AwsClientInterface
{
     ...
     * @param CommandInterface $command Command to execute
     *
     * @return \EDDAmazon\Vendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function executeAsync(CommandInterface $command);

    /**
     * Returns a promise that is fulfilled with an
     * {@see \EDDAmazon\Vendor\Aws\Credentials\CredentialsInterface} object.
     *
     ...
     *
     * @return \EDDAmazon\Vendor\Aws\Api\Service
     */
     ...
     *
     * @return \EDDAmazon\Vendor\Aws\ResultPaginator
     * @throws \UnexpectedValueException if the iterator config is invalid.
     */
     ...
     *                              can be provided in an associative array in
     *                              the @waiter key.
     * @return \EDDAmazon\Vendor\Aws\Waiter
     * @throws \UnexpectedValueException if the waiter is invalid.
     */
