...
use EDDAmazon\Vendor\Aws\S3\Exception\S3Exception;
...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * @param array  $options EDDAmazon\Vendor\Aws\S3\BatchDelete options array.
     *
     * @see EDDAmazon\Vendor\Aws\S3\S3Client::listObjects
     ...
     *   function signature like `function (EDDAmazon\Vendor\Aws\Command $command) {...}`.
     ...
     *
     * @see EDDAmazon\Vendor\Aws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see EDDAmazon\Vendor\Aws\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in EDDAmazon\Vendor\Aws\S3\Transfer::__construct
     *
     * @see EDDAmazon\Vendor\Aws\S3\Transfer for more options and customization
     */
