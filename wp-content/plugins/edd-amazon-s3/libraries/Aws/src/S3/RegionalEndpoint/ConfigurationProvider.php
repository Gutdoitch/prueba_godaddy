<?php
namespace EDDAmazon\Vendor\Aws\S3\RegionalEndpoint;
...
use EDDAmazon\Vendor\Aws\S3\RegionalEndpoint\Exception\ConfigurationException;
use EDDAmazon\Vendor\GuzzleHttp\Promise;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \EDDAmazon\Vendor\Aws\S3\RegionalEndpoint\ConfigurationInterface}
 * or rejected with an {@see \EDDAmazon\Vendor\Aws\S3\RegionalEndpoint\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see \EDDAmazon\Vendor\Aws\S3\RegionalEndpoint\ConfigurationProvider::chain}. This function
