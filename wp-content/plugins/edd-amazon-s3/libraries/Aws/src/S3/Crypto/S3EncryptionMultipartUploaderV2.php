...
use EDDAmazon\Vendor\Aws\S3\MultipartUploader;
use EDDAmazon\Vendor\Aws\S3\S3ClientInterface;
...
class S3EncryptionMultipartUploaderV2 extends MultipartUploader
{
     ...
     *   signature like `function (EDDAmazon\Vendor\Aws\Command $command) {...}`.
     * - before_upload: (callable) Callback to invoke before any `UploadPart`
     *   operations. The callback should have a function signature like
     *   `function (EDDAmazon\Vendor\Aws\Command $command) {...}`.
     ...
     * - state: (EDDAmazon\Vendor\Aws\Multipart\UploadState) An object that represents the state
