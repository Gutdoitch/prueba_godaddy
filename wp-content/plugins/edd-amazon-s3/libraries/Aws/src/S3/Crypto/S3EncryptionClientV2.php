...
use EDDAmazon\Vendor\Aws\Crypto\DecryptionTraitV2;
use EDDAmazon\Vendor\Aws\Exception\CryptoException;
use EDDAmazon\Vendor\Aws\HashingStream;
use EDDAmazon\Vendor\Aws\PhpHash;
use EDDAmazon\Vendor\Aws\Crypto\AbstractCryptoClientV2;
use EDDAmazon\Vendor\Aws\Crypto\EncryptionTraitV2;
use EDDAmazon\Vendor\Aws\Crypto\MetadataEnvelope;
use EDDAmazon\Vendor\Aws\Crypto\MaterialsProvider;
use EDDAmazon\Vendor\Aws\Crypto\Cipher\CipherBuilderTrait;
use EDDAmazon\Vendor\Aws\S3\S3Client;
 ...
 *
 * <code>
 * use EDDAmazon\Vendor\Aws\Crypto\KmsMaterialsProviderV2;
 * use EDDAmazon\Vendor\Aws\S3\Crypto\S3EncryptionClientV2;
 * use EDDAmazon\Vendor\Aws\S3\S3Client;
 *
...
class S3EncryptionClientV2 extends AbstractCryptoClientV2
{
     ...
     *   determined.
     *
     * @return \EDDAmazon\Vendor\Aws\Result PutObject call result with the details of uploading
     *                     the encrypted file.
     *
     * @throws \InvalidArgumentException Thrown when arguments above are not
     *                                   passed or are passed incorrectly.
     ...
     *   materials providers. Defaults to false.
     *
     * @return \EDDAmazon\Vendor\Aws\Result GetObject call result with the 'Body' field
