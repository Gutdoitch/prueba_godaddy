...
use EDDAmazon\Vendor\Aws\Multipart\AbstractUploader;
use EDDAmazon\Vendor\Aws\PhpHash;
use EDDAmazon\Vendor\Aws\ResultInterface;
use EDDAmazon\Vendor\GuzzleHttp\Psr7;
use EDDAmazon\Vendor\Psr\Http\Message\StreamInterface as Stream;
use EDDAmazon\Vendor\Aws\S3\Exception\S3MultipartUploadException;
