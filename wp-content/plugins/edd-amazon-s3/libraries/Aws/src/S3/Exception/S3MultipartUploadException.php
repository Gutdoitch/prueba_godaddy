<?php
namespace EDDAmazon\Vendor\Aws\S3\Exception;

use EDDAmazon\Vendor\Aws\CommandInterface;
use EDDAmazon\Vendor\Aws\Exception\AwsException;
use EDDAmazon\Vendor\Aws\Multipart\UploadState;

class S3MultipartUploadException extends \EDDAmazon\Vendor\Aws\Exception\MultipartUploadException
{
