<?php
namespace EDDAmazon\Vendor\Aws\S3\UseArnRegion;
...
use EDDAmazon\Vendor\Aws\S3\UseArnRegion\Exception\ConfigurationException;
use EDDAmazon\Vendor\GuzzleHttp\Promise;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \EDDAmazon\Vendor\Aws\S3\UseArnRegion\ConfigurationInterface}
 * or rejected with an {@see \EDDAmazon\Vendor\Aws\S3\UseArnRegion\Exception\ConfigurationException}.
 *
 * <code>
 * use EDDAmazon\Vendor\Aws\S3\UseArnRegion\ConfigurationProvider;
 ...
 * {@see EDDAmazon\Vendor\Aws\S3\UseArnRegion\ConfigurationProvider::chain}. This function
