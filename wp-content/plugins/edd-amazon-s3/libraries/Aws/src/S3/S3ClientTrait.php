...
use EDDAmazon\Vendor\Aws\Api\Parser\PayloadParserTrait;
...
use EDDAmazon\Vendor\GuzzleHttp\Promise\RejectedPromise;
 ...
 * classes implementing \EDDAmazon\Vendor\Aws\S3\S3ClientInterface
 */
trait S3ClientTrait
{
    ...
    public function deleteMatchingObjectsAsync(
        ...
        if ($regex) {
            $iter = \EDDAmazon\Vendor\Aws\filter($iter, function ($c) use ($regex) {
