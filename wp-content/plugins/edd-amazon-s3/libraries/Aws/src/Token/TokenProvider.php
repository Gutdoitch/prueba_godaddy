<?php
namespace EDDAmazon\Vendor\Aws\Token;

use EDDAmazon\Vendor\Aws;
use EDDAmazon\Vendor\Aws\Api\DateTimeResult;
use EDDAmazon\Vendor\Aws\CacheInterface;
use EDDAmazon\Vendor\Aws\Exception\TokenException;
use EDDAmazon\Vendor\GuzzleHttp\Promise;

/**
 * Token providers are functions that accept no arguments and return a
 * promise that is fulfilled with an {@see \EDDAmazon\Vendor\Aws\Token\TokenInterface}
 * or rejected with an {@see \EDDAmazon\Vendor\Aws\Exception\TokenException}.
 *
 * <code>
 ...
 * {@see EDDAmazon\Vendor\Aws\Token\TokenProvider::chain}. This function accepts
...
class TokenProvider
{
     ...
     * instance of EDDAmazon\Vendor\Aws\CacheInterface. Forwards calls when no token found
     ...
     *
     * @return SsoToken
     * @see EDDAmazon\Vendor\Aws\Token\SsoToken for $config details.
     */
