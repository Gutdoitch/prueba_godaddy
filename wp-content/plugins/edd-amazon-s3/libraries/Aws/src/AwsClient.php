...
use EDDAmazon\Vendor\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use EDDAmazon\Vendor\Aws\EndpointV2\EndpointProviderV2;
use EDDAmazon\Vendor\Aws\Exception\AwsException;
use EDDAmazon\Vendor\Aws\Signature\SignatureProvider;
use EDDAmazon\Vendor\GuzzleHttp\Psr7\Uri;
...
class AwsClient implements AwsClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (EDDAmazon\Vendor\Aws\Credentials\CredentialsInterface|array|bool|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   EDDAmazon\Vendor\Aws\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See EDDAmazon\Vendor\Aws\Credentials\CredentialProvider for
     *   a list of built-in credentials providers. If no credentials are
     *   provided, the SDK will attempt to load them from the environment.
     * - token:
     *   (EDDAmazon\Vendor\Aws\Token\TokenInterface|array|bool|callable) Specifies
     *   the token used to authorize requests. Provide an
     *   EDDAmazon\Vendor\Aws\Token\TokenInterface object, an associative array of
     *   "token" and an optional "expires" key, `false` to use no
     *   token, or a callable token provider used to create a
     *   token or return null. See EDDAmazon\Vendor\Aws\Token\TokenProvider for
     *   a list of built-in token providers. If no token is
     *   provided, the SDK will attempt to load one from the environment.
     * - csm:
     *   (EDDAmazon\Vendor\Aws\ClientSideMonitoring\ConfigurationInterface|array|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   EDDAmazon\Vendor\Aws\ClientSideMonitoring\ConfigurationInterface object, a callable
     ...
     *   EDDAmazon\Vendor\GuzzleHttp\TransferStats). HTTP handlers must support an
     ...
     *   of S3).
     * - endpoint_discovery: (EDDAmazon\Vendor\Aws\EndpointDiscovery\ConfigurationInterface,
     *   EDDAmazon\Vendor\Aws\CacheInterface, array, callable) Settings for endpoint discovery.
     *   Provide an instance of EDDAmazon\Vendor\Aws\EndpointDiscovery\ConfigurationInterface,
     *   an instance EDDAmazon\Vendor\Aws\CacheInterface, a callable that provides a promise for
     ...
     *   is required. See EDDAmazon\Vendor\Aws\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     *   EDDAmazon\Vendor\Aws\ResultInterface object or rejected with an
     *   EDDAmazon\Vendor\Aws\Exception\AwsException. A handler does not accept a next handler
     ...
     *   available regions.
     * - retries: (int, EDDAmazon\Vendor\Aws\Retry\ConfigurationInterface, EDDAmazon\Vendor\Aws\CacheInterface,
     *   array, callable) Configures the retry mode and maximum number of
     *   allowed retries for a client (pass 0 to disable retries). Provide an
     *   integer for 'legacy' mode with the specified number of retries.
     *   Otherwise provide an instance of EDDAmazon\Vendor\Aws\Retry\ConfigurationInterface, an
     *   instance of  EDDAmazon\Vendor\Aws\CacheInterface, a callable function, or an array with
     ...
     *   EDDAmazon\Vendor\Aws\Signature\SignatureProvider for a list of built-in providers
    ...
    private function parseClass()
    {
        ...
        return [
            strtolower($service),
            "EDDAmazon\Vendor\Aws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \EDDAmazon\Vendor\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \EDDAmazon\Vendor\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
