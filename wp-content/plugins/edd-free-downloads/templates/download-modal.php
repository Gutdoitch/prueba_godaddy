...
<form id="edd_free_download_form" method="post">
	...
	<p>
		...
		<input <?php if ( is_user_logged_in() ) { echo 'readonly'; } ?> type="text" name="edd_free_download_email" id="edd_free_download_email" class="edd-free-download-field" placeholder="<?php _e( 'Email Address', 'edd-free-downloads' ); ?>" value="<?php echo $email; ?>" tabindex="-1" />
	</p>
	...
	<div class="edd-free-download-errors">
		...
		// Processing error
		?>
		<p id="edd-free-download-error-processing"></p>
	</div>
