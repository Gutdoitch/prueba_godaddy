<?php
class wooproductoptionsMetabox {
	...
	public function add_meta_boxes() {
		foreach ( $this->screen as $single_screen ) {
			add_meta_box(
				'productoptions',
				__( 'Product Information', 'mayosis-core' ),
...
if (class_exists('wooproductoptionsMetabox')) {
	new wooproductoptionsMetabox;
};
