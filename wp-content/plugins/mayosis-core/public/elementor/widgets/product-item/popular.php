...
class mayosis_pb_poular_products extends Widget_Base {

   public function get_name() {
      return 'mayosis-pb-poular-products';
   }

   public function get_title() {
      return __( 'Mayosis Popular Product', 'mayosis-core' );
   }
public function get_categories() {
   ...
   protected function register_controls() {
        $this->start_controls_section(
			'mayosis_pb_poular_products',
			[
				'label' => __( 'Popular Product', 'mayosis-core' ),
...
Plugin::instance()->widgets_manager->register( new mayosis_pb_poular_products);
?>