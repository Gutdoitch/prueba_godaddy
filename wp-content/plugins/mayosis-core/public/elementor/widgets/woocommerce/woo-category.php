...
class mayosis_woo_category extends Widget_Base {

    public function get_name() {
        return 'mayosis-woo-category';
    }

    public function get_title() {
        return __( 'Mayosis Woo Category', 'mayosis-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'section_edd',
            [
                'label' => __( 'Mayosis Woo Category', 'mayosis-core' ),
        ...
        echo esc_attr($custom_css); ?>">
            ...
            <div class="grid--download--list col-count-<?php echo $listcol; ?>">
                ...
                if  ($hide_empty_cats == "false"){
                        $ttlcatarg = array( 'taxonomy' => 'product_cat', 'title_li' => "",'hide_title_if_empty' => false,'hide_empty' => false,'number' => $amount,);
                    } else {
                        $ttlcatarg = array( 'taxonomy' => 'product_cat', 'title_li' => "", 'number' => $amount,);
                    }
                ?>
                ...
                <?php } else { ?>
                    ...
                    ?>
                        ...
                        <?php $categories=get_categories( array( 'taxonomy' => 'product_cat','parent' => $pid, 'number' => $amount,)); ?>
                    <?php } else{ ?>
                        <?php $categories=get_categories(
                            array( 'taxonomy' => 'product_cat', 'number' => $amount, )
                        ); ?>

                    <?php } ?>
                    <?php foreach ( $categories as $term ) : ?>
                        <?php $category_grid_image = get_term_meta($term->term_id, 'thumbnail_id', true);
            ...
            <?php }  else { ?>
                ...
                <?php if ($carousel_enable=='enable'){ ?>
                    ...
                    <?php if($showcid=='parent'){?>
                        <?php $categories=get_categories(
                            array( 'taxonomy' => 'product_cat','parent' => $pid, 'number' => $amount, )
                        ); ?>
                    <?php } else{ ?>
                        <?php $categories=get_categories(
                            array( 'taxonomy' => 'product_cat', 'number' => $amount, )
                    ...
                    <div id="carousel-category-msv-elmentor" class="edd-category-grid-carousel  swiper-container grid-cat-edd-<?php echo $curoselcol;?>">
                        ...
                        <div id="grid-cat-edd" class="swiper-wrapper grid-cat-edd">
                            <?php foreach ( $categories as $term ) : ?>
                             ...
                             $category_grid_image = get_term_meta($term->term_id, 'thumbnail_id', true);
                             $category_grid_image = wp_get_attachment_url($category_grid_image);
...
Plugin::instance()->widgets_manager->register( new mayosis_woo_category );
?>