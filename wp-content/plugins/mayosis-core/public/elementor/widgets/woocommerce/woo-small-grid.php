...
class mayosis_woo_grid_small extends Widget_Base {

    public function get_name() {
        return 'mayosis-woo-small-grid';
    }

    public function get_title() {
        return __( 'Mayosis Woo Small Grid', 'mayosis-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'section_edd',
            [
                'label' => __( 'Mayosis Woo Small Grid', 'mayosis-core' ),
...
Plugin::instance()->widgets_manager->register( new mayosis_woo_grid_small );
?>