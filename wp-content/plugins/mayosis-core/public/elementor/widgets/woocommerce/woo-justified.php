...
class mayosis_woo_justified_Elementor extends Widget_Base {

    public function get_name() {
        return 'mayosis-woo-justified';
    }

    public function get_title() {
        return __( 'Mayosis WOO Justified Grid', 'mayosis-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'section_edd',
            [
                'label' => __( 'Mayosis WOO Justified', 'mayosis-core' ),
...
$this->end_controls_section();
    ...
    protected function render( $instance = [] ) {
        ...
        $products_category_not=$settings['categorynotin'];
        ...
        global $post;
            ...
            $args = array('post_type' => 'product', 'numberposts' => $post_count, 'order' => (string)trim($post_order_term),);
     ...
     if(!empty($products_category_not[0])) {
      $args['tax_query'] = array(
        array(
          'taxonomy' => 'product_cat',
          'field'    => 'ids',
          'terms'    => $products_category_not,
          'operator' => 'NOT IN'
        )
      );
    }
            ...
            ?>
                        ...
                        if (strpos($mayosis_video,'youtube.com')==true){
                            ...
                            $mayosis_video_cls="mayosis-self-hosted-video";
                                    ...
                                    ?>
                                        <div class="item-thumbnail item-video-justify <?php echo esc_html($mayosis_video_cls);?>">
                        ...
                        edd_favorites_load_link( $product_id );
...
Plugin::instance()->widgets_manager->register( new mayosis_woo_justified_Elementor );
?>