...
Browse, Download & Use Our Resources To Design Faster & Get Your Payment Quicker!',
      ...
      $this->add_control(
			'section_image',
			[
				'label' => esc_html__( 'Title Seprator', 'textdomain' ),
      ...
      $this->add_control(
       ...
       $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .hero-title,{{WRAPPER}} .hero_section_sep_image' => 'text-align: {{VALUE}};',
				],
			]
		);
 ...
 <!-- Element Code start -->
  ...
  <div class="col-md-12  col-xs-12 col-sm-12 mayosis_theme_hero_box">
      ...
      <div class="has_char_anim">
                   ...
                   <div class="hero-description has_text_move_anim"><?php echo $settings['section_content']; ?></div>
                   
                   <?php if ($settings['section_image']['url']){ ?>
                   <div class="hero_section_sep_image has_fade_anim">
...
Plugin::instance()->widgets_manager->register( new Theme_hero_Elementor_Thing );
?>