...
function mayosis_enqueue_scripts_styles() {
	wp_register_script( 'mayosis_admin_js', plugins_url( 'mayosis-core/admin/js/user-image.js' ), array( 'jquery' ), '1.0.0', true );
					...
					<div id="current_img">
						...
						<?php else : ?>
							<img class="mayosis-current-img placeholder"
							     src="<?php echo esc_url( plugins_url( 'mayosis-core/admin/image/placeholder.jpg' ) ); ?>"/>
						<?php endif; ?>
					</div>
