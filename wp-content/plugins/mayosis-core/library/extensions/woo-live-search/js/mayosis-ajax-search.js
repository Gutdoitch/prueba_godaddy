(function($){
    ...
    function productSearch(form,query,currentQuery,timeout){
        ...
        form.next('.search-results').html('').removeClass('active');
         $( ".mayosis-ajax-s-offcanvas" ).removeClass( "offcanvas-full-height" );
                        ...
                        success: function(data) {
                            ...
                            if (!form.next('.search-results').hasClass('empty')) {
                                ...
                                if (data.length) {
                                    ...
                                    form.next('.search-results').html('<div class="mayosis-ajax-not-found">'+opt.noResults+'</div>').addClass('active');
